...
const FeesData = () => {
    ...
    const [data, setData] = useState([
        { id: 1, name: 'Corrine Johnson', feeHeadCode: 'Annual', feeHeadName: 'Annual' },
        { id: 2, name: 'Gladys Smith', feeHeadCode: 'Tuition', feeHeadName: 'Annual' },
    ]);
    const [classdata, setClassData] = useState([
        { id: 1, class: 'A', medium: 'English', minStrength: '30', maxStrength: '50', active: 'Yes' },
        { id: 2, class: 'A', medium: 'English', minStrength: '30', maxStrength: '50', active: 'No' }
    ])

    const [editingCell, setEditingCell] = useState({ rowId: null, property: null });
    ...
    const handleAddRow = () => {
        ...
        const newClassRow = { id: newClassRowId, class: '', medium: '', minStrength: '', maxStrength: '', active: '' };
                                                ...
                                                <div className="card-body">
                                                    <div className="table-responsive">
                                                        <table className="table table-hover text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                                            ...
                                                            <tbody>
                                                                {data.map((row) => (
                                                                    <tr key={row.id} onContextMenu={() => handleRowRightClick(row.id)}>
                                                                        <td>{row.id}</td>
                                                                        <td
                                                                            onClick={() => handleRowClick(row.id, 'name')}
                                                                            onBlur={handleInputBlur}
                                                                        >
                                                                            {editingCell.rowId === row.id && editingCell.property === 'name' ? (
                                                                                <input
                                                                                    type="text"
                                                                                    value={row.name}
                                                                        ...
                                                                        <td
                                                                            onClick={() => handleRowClick(row.id, 'feeHeadCode')}
                                                                            onBlur={handleInputBlur}
                                                                        >
                                                                            {editingCell.rowId === row.id && editingCell.property === 'feeHeadCode' ? (
                                                                                <input
                                                                                    type="text"
                                                                                    value={row.feeHeadCode}
                                                                                    onChange={(e) => handleInputChange(e, row.id, 'feeHeadCode')}
                                                                                    autoFocus
                                                                                />
                                                                            ) : (
                                                                                row.feeHeadCode
                                                                        ...
                                                                        <td
                                                                            onClick={() => handleRowClick(row.id, 'feeHeadName')}
                                                                            onBlur={handleInputBlur}
                                                                        >
                                                                            {editingCell.rowId === row.id && editingCell.property === 'feeHeadName' ? (
                                                                                <input
                                                                                    type="text"
                                                                                    value={row.feeHeadName}
                                                                                    onChange={(e) => handleInputChange(e, row.id, 'feeHeadName')}
                                                                                    autoFocus
                                                                                />
                                                                            ) : (
                                                                                row.feeHeadName
                                                    ...
                                                    {clickedRowId && (
                                                        <div
                                                            ...
                                                            style={{ top: 0, left: 0 }}
                                                        >
                                                            <div className="context-menu-item" onClick={handleAddRow}>
                                                                Add New Row
                                                            </div>
                                                                        ...
                                                                        <tbody>
                                                                            {classdata.map((row) => (
                                                                                <tr key={row.id} onContextMenu={() => handleRowRightClick(row.id)}>
                                                                                    <td>{row.id}</td>
                                                                                    <td
                                                                                        onClick={() => handleRowClick(row.id, 'class')}
                                                                                        onBlur={handleInputBlur}
                                                                                    >
                                                                                        {editingCell.rowId === row.id && editingCell.property === 'class' ? (
                                                                                            <input
                                                                                                type="text"
                                                                                                value={row.class}
                                                                                                onChange={(e) => handleInputChange(e, row.id, 'class')}
                                                                                                autoFocus
                                                                                            />
                                                                                        ) : (
                                                                                            row.class
                                                                                    ...
                                                                                    <td
                                                                                        onClick={() => handleRowClick(row.id, 'medium')}
                                                                                        onBlur={handleInputBlur}
                                                                                    >
                                                                                        {editingCell.rowId === row.id && editingCell.property === 'medium' ? (
                                                                                            <input
                                                                                                type="text"
                                                                                                value={row.medium}
                                                                                                onChange={(e) => handleInputChange(e, row.id, 'medium')}
                                                                                                autoFocus
                                                                                            />
                                                                                        ) : (
                                                                                            row.medium
                                                                                    ...
                                                                                    <td
                                                                                        onClick={() => handleRowClick(row.id, 'minStrength')}
                                                                                        onBlur={handleInputBlur}
                                                                                    >
                                                                                        {editingCell.rowId === row.id && editingCell.property === 'minStrength' ? (
                                                                                            <input
                                                                                                type="text"
                                                                                                value={row.minStrength}
                                                                                                onChange={(e) => handleInputChange(e, row.id, 'minStrength')}
                                                                                                autoFocus
                                                                                            />
                                                                                        ) : (
                                                                                            row.minStrength
                                                                                    ...
                                                                                    <td
                                                                                        onClick={() => handleRowClick(row.id, 'maxStrength')}
                                                                                        onBlur={handleInputBlur}
                                                                                    >
                                                                                        {editingCell.rowId === row.id && editingCell.property === 'maxStrength' ? (
                                                                                            <input
                                                                                                type="text"
                                                                                                value={row.maxStrength}
                                                                                                onChange={(e) => handleInputChange(e, row.id, 'maxStrength')}
                                                                                                autoFocus
                                                                                            />
                                                                                        ) : (
                                                                                            row.maxStrength
                                                                                    ...
                                                                                    <td
                                                                                        onClick={() => handleRowClick(row.id, 'active')}
                                                                                        onBlur={handleInputBlur}
                                                                                    >
                                                                                        {editingCell.rowId === row.id && editingCell.property === 'active' ? (
                                                                                            <input
                                                                                                type="text"
                                                                                                value={row.active}
                                                                                                onChange={(e) => handleInputChange(e, row.id, 'active')}
                                                                                                autoFocus
                                                                                            />
                                                                                        ) : (
                                                                                            row.active
